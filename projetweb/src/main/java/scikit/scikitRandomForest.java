...
public class scikitRandomForest extends scikitMethod {

	int nbArbre;
	
	public scikitRandomForest(String strAdresse, String strVariable, double propApp, ScriptEngine engine, int nbTrees) {
	...
	public double run() {
	    ...
	    try{
	    	...
	    	InputStream flux = new FileInputStream("src/coca/randomForest.py");
